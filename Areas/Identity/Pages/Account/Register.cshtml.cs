...
namespace hoangstore.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required(ErrorMessage = "Vui lòng nhập Họ và tên đệm"), StringLength(50)]
            ...
            [Required(ErrorMessage = "Vui lòng nhập Địa chỉ"),StringLength(256)]
